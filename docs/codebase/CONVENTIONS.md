...
|------|------|---------|----------|
| Source Files (C++) | `snake_case` with `.cpp` and `.hpp` | `camera_streamer_component.cpp`, `sts_protocol.hpp`, `teleop_uarm_node.cpp` | [`lekiwi_perception/src/camera_streamer_component.cpp`](file:///root/docker_ws/lekiwi_ros2/lekiwi_perception/src/camera_streamer_component.cpp), [`teleop_zhongli_servo_hw/src/teleop_uarm_node.cpp`](file:///root/docker_ws/lekiwi_ros2/teleop_zhongli_servo_hw/src/teleop_uarm_node.cpp) |
| Source Files (Python) | `snake_case` with `.py` | `task_orchestrator.py`, `lerobot_arm_bridge.py`, `handeye_calibration_node.py` | [`lekiwi_control/lekiwi_control/task_orchestrator.py`](file:///root/docker_ws/lekiwi_ros2/lekiwi_control/lekiwi_control/task_orchestrator.py), [`handeye_calibration/handeye_calibration/handeye_calibration_node.py`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration/handeye_calibration/handeye_calibration_node.py) |
| ROS 2 Messages / Services | `PascalCase` with `.msg` and `.srv` | `CameraMode.msg`, `HailoInferenceStatus.msg`, `SetTorqueEnabled.srv` | [`lekiwi_interfaces/msg/CameraMode.msg`](file:///root/docker_ws/lekiwi_ros2/lekiwi_interfaces/msg/CameraMode.msg), [`lekiwi_interfaces/srv/SetTorqueEnabled.srv`](file:///root/docker_ws/lekiwi_ros2/lekiwi_interfaces/srv/SetTorqueEnabled.srv) |
| C++ Types / Classes | `PascalCase` | `HailoChessInferenceComponent`, `LeKiwiFeetechHardwareInterface`, `TeleopUarmNode` | [`lekiwi_perception/include/hailo_chess_inference_component.hpp:31`](file:///root/docker_ws/lekiwi_ros2/lekiwi_perception/include/hailo_chess_inference_component.hpp#L31), [`teleop_zhongli_servo_hw/include/teleop_zhongli_servo_hw/teleop_uarm_node.hpp`](file:///root/docker_ws/lekiwi_ros2/teleop_zhongli_servo_hw/include/teleop_zhongli_servo_hw/teleop_uarm_node.hpp) |
| Python Types / Classes | `PascalCase` | `HandEyeCalibrationNode`, `CharucoDetectorHelper`, `RobotArmManager`, `HandEyeSolver` | [`handeye_calibration/handeye_calibration/handeye_calibration_node.py`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration/handeye_calibration/handeye_calibration_node.py) |
| Functions & Methods | `snake_case` or `camelCase` (with trailing `_` for C++ private members) | `handle_sample()`, `connect_hardware()`, `gscam_config_`, `port_` | [`lekiwi_control/lekiwi_control/fsm.py:37`](file:///root/docker_ws/lekiwi_ros2/lekiwi_control/lekiwi_control/fsm.py#L37), [`teleop_zhongli_servo_hw/src/teleop_uarm_node.cpp:40`](file:///root/docker_ws/lekiwi_ros2/teleop_zhongli_servo_hw/src/teleop_uarm_node.cpp#L40) |
