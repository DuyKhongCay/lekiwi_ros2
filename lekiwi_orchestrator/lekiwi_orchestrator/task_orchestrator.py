...
"""
Camera Mode and Perception Lifecycle Orchestrator for LeKiwi.

Bootstraps camera hub lifecycle states and enforces legal transitions across
the 4-mode CameraMode FSM (STANDBY, NAVIGATING, CHESS_THINKING, MANIPULATION_LEROBOT).
"""
...
from lekiwi_orchestrator.fsm import MODE_NAMES, is_transition_allowed
