...
| **SolvePnP Spatial Estimation** | [`lekiwi_tag_localization/src/chessboard_pose_estimator.cpp`](file:///root/docker_ws/lekiwi_ros2/lekiwi_tag_localization/src/chessboard_pose_estimator.cpp), [`handeye_calibration/handeye_calibration/charuco_detector.py`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration/handeye_calibration/charuco_detector.py) | Computes accurate 6-DoF chessboard / ChArUco transform relative to camera optical frames. |
| **Hand-Eye Kinematic Extrinsics Mapping** | [`handeye_calibration`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration), [`lekiwi_description/urdf/sensors_calibration.xacro`](file:///root/docker_ws/lekiwi_ros2/lekiwi_description/urdf/sensors_calibration.xacro) | Solves $AX=XB$ dual transformation matrices to map physical camera frames onto `base_footprint`. |
