...
static const std::map<std::string, std::string> PIECE_PNG_NAMES = {
  {"B", "w-bishop.png"}, {"K", "w-king.png"}, {"N", "w-knight.png"},
  {"P", "w-pawn.png"},   {"Q", "w-queen.png"},  {"R", "w-rook.png"},
  {"b", "b-bishop.png"}, {"k", "b-king.png"}, {"n", "b-knight.png"},
  {"p", "b-pawn.png"},   {"q", "b-queen.png"},  {"r", "b-rook.png"}
};
...
void ChessVisualizerComponent::guiThreadLoop() {
  ...
  while (rclcpp::ok() && is_running_) {
...

    {
      ...
      if (!is_running_ || !rclcpp::ok()) break;
