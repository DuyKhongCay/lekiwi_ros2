...
|------|---------|----------|
| [`lekiwi_interfaces/`](file:///root/docker_ws/lekiwi_ros2/lekiwi_interfaces) | Custom ROS 2 messages (`CameraMode`, `HailoInferenceStatus`, `DriveStatus`, `ServoTelemetry`) and services (`SetCamMode`, `ResetMotorBus`, `SetTorqueEnabled`) | [`lekiwi_interfaces/package.xml`](file:///root/docker_ws/lekiwi_ros2/lekiwi_interfaces/package.xml) |
| [`handeye_calibration/`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration) | Native OpenCV GUI hand-eye calibration node with auto lead-through arm torque disable, ChArUco PnP detection, Park/Tsai-Lenz solver, and multi-board PDF generator | [`handeye_calibration/package.xml`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration/package.xml) |
...
| [`lekiwi_description/`](file:///root/docker_ws/lekiwi_ros2/lekiwi_description) | URDF / Xacro kinematics and joint definitions (`lekiwi_robot.urdf.xacro`, `ros2_control.xacro`, `sensors_calibration.xacro`), mesh STL files, and Hand-Eye calibration YAML assets | [`lekiwi_description/urdf/lekiwi_robot.urdf.xacro`](file:///root/docker_ws/lekiwi_ros2/lekiwi_description/urdf/lekiwi_robot.urdf.xacro) |
...
- **Subsystem entry points**:
  ...
  - `ros2 launch handeye_calibration handeye_calibration.launch.py` ([`handeye_calibration/launch/handeye_calibration.launch.py`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration/launch/handeye_calibration.launch.py)): Launches the native OpenCV GUI Hand-Eye calibration tool with lead-through servo torque disable.
- **Executable Node Binaries**:
  ...
  - `handeye_calibration_node` ([`handeye_calibration/handeye_calibration/handeye_calibration_node.py`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration/handeye_calibration/handeye_calibration_node.py))
  - `generate_charuco` ([`handeye_calibration/handeye_calibration/generate_charuco.py`](file:///root/docker_ws/lekiwi_ros2/handeye_calibration/handeye_calibration/generate_charuco.py))
...
|----------|-------------------|------------------------|
| `lekiwi_interfaces` | Message and service interface definitions | Algorithmic logic, node executables |
| `handeye_calibration` | Native OpenCV GUI hand-eye calibration, ChArUco PnP pose detection, Park/Tsai solver, A4/A3 target generator | High-level autonomous navigation, real-time motor PID loops |
